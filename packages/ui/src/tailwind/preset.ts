...
const preset = {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        "paper-sm":
          "0 1px 3px -1px rgba(60, 40, 25, 0.08), 0 1px 2px 0 rgba(60, 40, 25, 0.06)",
        "paper-md":
          "0 4px 8px -2px rgba(60, 40, 25, 0.10), 0 2px 4px -2px rgba(60, 40, 25, 0.08)",
        "paper-float":
          "0 12px 28px -6px rgba(60, 40, 25, 0.15), 0 6px 12px -4px rgba(60, 40, 25, 0.10)",
      },
      keyframes: {
        "skeleton-shimmer": {
